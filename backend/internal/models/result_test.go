...
func TestResult_SimpleMajority(t *testing.T) {
	...
	if err != nil {
		t.Error("failed to marshal result")
	}
	if string(body) != expectedJSON(3, 2, 2, 1) {
		t.Errorf("unexpected result: %s", string(body))
	}
}
...
func TestResult_Runoff(t *testing.T) {
	...
	if string(body) != expectedJSON(5, 3, 1, 2) {
		t.Errorf("unexpected result: %s", string(body))
	}
}
...
func TestResult_TieForLast(t *testing.T) {
	...
	*/
	if string(body) != expectedJSON(6, 4, 2, 3) {
		t.Errorf("unexpected result: %s", string(body))
	}
}
...
func TestResult_InfiniteTieForLast(t *testing.T) {
	...
	*/
	if string(body) != expectedJSON(8, 5, 3, 3) {
		t.Errorf("unexpected result: %s", string(body))
	}
}
